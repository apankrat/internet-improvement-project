...
(function(){
	...
	if (window.isSelectivityInstalled)
		return;
	window.isSelectivityInstalled = true;
...
//		console.log('loading ' + url + ' ...');
	...
	var js1 = 'http://code.jquery.com/jquery-1.5.2.min.js';
	var js2 = 'https://raw.github.com/apankrat/internet-improvement-project/master/_shared/js/jquery.color.min.js';
